...
class Prompter(prompter.Prompter):
    """
    Prompter provides the generation of prompts specific to the sorting
...
{{
    "List 1": [3, 4, 3, 5, 7, 8, 1, 0],
    "List 2": [2, 9, 2, 4, 7, 1, 5, 5]
}} </Instruction>

<Example>
Input: [9, 6, 7, 7, 2, 0, 2, 2, 5, 2, 5, 1, 2, 8, 3, 8]
Output: 
{{
    "List 1": [9, 6, 7, 7, 2, 0, 2, 2],
    "List 2": [5, 2, 5, 1, 2, 8, 3, 8]
}}
</Example>
...
class Parser(parser.Parser):
    """
    Parser provides the parsing of language model reponses specific to
    the sorting example.
