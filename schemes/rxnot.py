...
"""
        ...
        cache_script = Path(f'cache/script_rxnot-4o')
        # cache_knowledge = Path(f'cache/knowledge_5rxnot-{self.args.planner_llm}')
        ...
        if cache_script.exists():
            ...
            if not Path('cache/knowedge_rxnot-o4-mini-high').exists():
            ...
            # knowledge = readf('cache/knowedge_5rxnot-o3-mini-high')
            knowledge = readf('cache/knowedge_rxnot-o4-mini-high')
            ...
            print('=======')
            input()
            # self.script = readf('cache/script_5rxnot-o1')
            # self.script = readf('cache/script_rxnot-o4-mini-high')
